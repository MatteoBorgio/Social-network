...
export default function VerifyVerificationCode({ navigation }) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            console.log("Errore Verification Code:", error);
            ...
            <View style={styles.scrollContainer}>
                ...
                <View style={styles.formContainer}>
                    ...
                    <TextInput
                        ...
                        autoCorrect={false}
                    />
                    {submitted && errors.providedCode && <Text style={styles.errorText}>{errors.providedCode}</Text>}
                </View>
                <TouchableOpacity
                    style={styles.primaryButton}
                    onPress={() => handleSubmit()}
                >
                    <Text style={styles.primaryButtonText}>Invia il codice</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={styles.secondaryButton}
                    onPress={() => navigation.navigate("SendVerificationCode")}
                >
                    <Text style={styles.secondaryButtonText}>Problemi con il codice? Rinvialo</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    )
